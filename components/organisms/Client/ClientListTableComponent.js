...
const ClientListTableComponent = () => {
  // Sample data for demonstration
  const data = useMemo(
    () => [
      { id: 1, name: 'John Doe', email: 'arifianto.budi@jec.co.id',exp_date:"02 feb 2024", company: 'PT. Nitrasanata Dharma',group:"JEC",status:"Active",quota:'2' },
      { id: 2, name: 'Jane Smith', email: 'fajar.wahyudianto@jec.co.id',exp_date:"02 feb 2024", company: 'California',group:"JEC",status:"Expired",quota:'50' },
      { id: 3, name: 'Bob Johnson', email: 'teguh.adi@jec.co.id',exp_date:"02 feb 2024", company: 'Texas',group:"JEC",status:"Suspend" ,quota:'50'},
      { id: 4, name: 'John Doe', email: 'arifianto.budi@jec.co.id',exp_date:"02 feb 2024", company: 'PT. Nitrasanata Dharma',group:"JEC",status:"Active" ,quota:'30'},
      { id: 5, name: 'Jane Smith', email: 'fajar.wahyudianto@jec.co.id',exp_date:"02 feb 2024", company: 'California',group:"JEC",status:"Active" ,quota:'10'},
      { id: 6, name: 'Bob Johnson', email: 'teguh.adi@jec.co.id',exp_date:"02 feb 2024", company: 'Texas',group:"JEC",status:"Active" ,quota:'50',quota:'23'},
      { id: 7, name: 'John Doe', email: 'arifianto.budi@jec.co.id',exp_date:"02 feb 2024", company: 'PT. Nitrasanata Dharma',group:"JEC",status:"Active",quota:'44' },
      { id: 8, name: 'Jane Smith', email: 'fajar.wahyudianto@jec.co.id',exp_date:"02 feb 2024", company: 'California',group:"JEC",status:"Active" ,quota:'11'},
      { id: 9, name: 'Bob Johnson', email: 'teguh.adi@jec.co.id',exp_date:"02 feb 2024", company: 'Texas',group:"JEC",status:"Active" ,quota:'50'},
      { id: 10, name: 'Bob Johnson', email: 'teguh.adi@jec.co.id',exp_date:"02 feb 2024", company: 'Texas',group:"JEC",status:"Active" ,quota:'50'},
      { id: 11, name: 'Bob Johnson', email: 'teguh.adi@jec.co.id',exp_date:"02 feb 2024", company: 'Texas',group:"JEC",status:"Active" ,quota:'50'},
      { id: 12, name: 'Bob Johnson', email: 'teguh.adi@jec.co.id',exp_date:"02 feb 2024", company: 'Texas',group:"JEC",status:"Active" ,quota:'50'},
      { id: 13, name: 'Bob Johnson', email: 'teguh.adi@jec.co.id',exp_date:"02 feb 2024", company: 'Texas',group:"JEC",status:"Active" ,quota:'50'},
        ...
        Cell:({ cell }) =>{
          ...
          return(
            <div className="dropdown d-inline-block">
              ...
              {cell.row.values.status.toLowerCase() == 'active' ? (
